...
![Old LEV50 battery](_attachments/IMG_2531_1751892503984215.JPG)

*Old 50ah LEV50.*

![New NMC battery with M8 terminals](_attachments/IMG_2535_1751892503980072.JPG)

*New 94ah NMC. Note the M8 terminals (custom ordered instead of the default M6) to match the LEV50.*

![Battery size comparison](_attachments/IMG_2536_17518925039985049.JPG)

*The LEV50 (left) and NMC (right) have slightly different form factors. The NMC is slightly narrower than the LEV50.*

![Height comparison of batteries](_attachments/IMG_2537_1751892504002529.JPG)

*The NMC (foreground) is shorter than the LEV50 (background).*

![Length comparison of batteries](_attachments/IMG_2539_17518925040066292.JPG)
...
1. See the [service manual](https://web.archive.org/web/20241223155351/http://mmc-manuals.ru/manuals/i-miev/online/Service_Manual/2017/index_M1.htm) for instructions on removing and opening the pack
    ...
    ![8-cell battery module](_attachments/IMG_2528_1751892504011963.JPG)
...
2. It is recommended to mark the positioning of the positive terminals before opening the module. This will ease assembly and reduce the chance of making a polarity error that might destroy the CMUs.
    ...
    ![Marked battery terminals](_attachments/IMG_2554_1751892504019211.JPG)
...
3. Remove the mounting brackets holding the metal clam shell together.
    ...
    ![Left mounting bracket removed](_attachments/IMG_2557_1751892504024575.JPG)

    *Left bracket (connector side) removed.*

    ![Right mounting bracket removed](_attachments/IMG_2558_1751892504034296.JPG)

    *Right bracket removed.*

4. Remove the top metal clam shell by prying it over the 8 plastic tabs.

    ![Plastic tabs on clam shell](_attachments/clam_shell_tabs_1751892504029442.jpg)

    *Plastic tabs holding on the metal clam shell.*

    ![Close up of plastic tabs](_attachments/IMG_2707_1751892504041951.JPG)

    *Close up of two of the tabs.*

    ![Top clam shell removed](_attachments/IMG_2560_175189250405269.JPG)

    *Top metal clam shell removed.*

5. Pry off the plastic top cover, which is held on by tabs.

    ![Plastic cover removed](_attachments/IMG_2561_1751892504047725.JPG)

    *Plastic cover removed.*

6. Remove the cable between the CMU and daughter board.

    ![CMU cable connection](_attachments/daughter_board_cable_1751892504059765.jpg)
    ...
    *Cable between the CMU and daughter board. Depress the tab (circled) to separate the plug from the socket. Repeat on the other end.*
    ...
    ![CMU cable removed](_attachments/IMG_2563_1751892504068529.JPG)

    *Cable removed.*

7. Remove the bus bar between the two submodules.

    ![Bus bar connecting submodules](_attachments/bus_bar_linking_modules_1751892504087863.jpg)

    *Remove the bus bar linking the two submodules.*

    ![Bus bar removed from submodules](_attachments/IMG_2566_1751892504075469.JPG)

    *Bus bar removed.*

8. Remove the bottom metal clam shell by prying it over the 8 plastic tabs.

    ![Bottom clam shell plastic tabs](_attachments/IMG_2569_1751892504092445.JPG)

    *Plastic tabs holding on the metal clam shell.*

    ![Module on side for removal](_attachments/IMG_2567_175189250408759.JPG)
    ...
    *It may be helpful to place the module on its side to free the battery cage from the clam shell so as not to be fighting against gravity.*
    ...
    ![Bottom clam shell removed](_attachments/IMG_2571_1751892504120824.JPG)
...
1. Remove the 4 screws attaching the CMU daughter board to the batteries.
    ...
    ![CMU daughter board screw locations](_attachments/daughter_board_screws_removing_1751892504109699.jpg)

    *Remove the four circled screws.*

    ![CMU screws removed](_attachments/IMG_2576_17518925041209202.JPG)
...
2. Remove the top webbing of the battery cage.
    ...
    ![Adhesive points on webbing](_attachments/cage_top_webbing_adhesive_175189250410412.jpg)

    *There is adhesive at the circular points.*

    ![Webbing locator tab detail](_attachments/cage_top_webbing_locator_tab_17518925041330938.jpg)
    ...
    *Care must be taken when slicing the adhesive at the circular points (green circle) not to sever the nearby locating tab (red circle).*
    ...
    ![Using putty knife to cut adhesive](_attachments/IMG_2580_1751892504128587.JPG)

    *A putty knife with light tapping can be used to cut the adhesive without breaking the plastic.*

    ![Putty knife between plastic pieces](_attachments/IMG_2581_1751892504138564.JPG)
    ...
    *Wedge the putty knife between the two pieces of plastic at an adhesion point. Gently tap the putty knife to cut the adhesive. Repeat for the remaining 6 (total 7) adhesion points*
    ...
    ![Top webbing removed](_attachments/IMG_2585_1751892504144211.JPG)
...
3. Remove the batteries from the cage.
    ...
    ![Flipping cage to remove batteries](_attachments/IMG_2662_1751892504149281.JPG)
    ...
    *To start the batteries moving, it may be helpful to flip the cage upside down, block up the edges of the cage, and push the bottom of the batteries down.*
    ...
    ![Batteries moving as unit](_attachments/IMG_2586_175189250415579.JPG)

    *The high coefficient of friction on the rubber spacers means the batteries will likely move as an unit.*

    ![All batteries removed](_attachments/IMG_2588_1751892504166367.JPG)
...
1. Mark the polarity on the inside of the battery cage. This will ease in reassembly and reduce the probability of an error.
    ...
    ![Battery cage polarity markings](_attachments/battery_cage_polarity_inside_17518925041765819.jpg)
...
2. Mark the polarity on the new batteries. This will ease in reassembly and reduce the probability of an error.
    ...
    ![Unmarked battery terminals](_attachments/IMG_2669_1751892504160884.JPG)

    *Polarity is not well-marked on the new terminals.*

    ![Marking battery polarity](_attachments/IMG_2670_1751892504171788.JPG)
...
3. Remove ~2mm on each side of the battery cage base to accommodate the slightly longer, NMC batteries.
    ...
    ![Battery length comparison](_attachments/battery_cage_battery_length_17518925041825511.jpg)

    *The new NMC batteries are slightly longer and don't fit in the base of the battery cage.*

    ![Left side battery overhang](_attachments/IMG_2594_17518925041920269.JPG)

    *Battery overhang on left.*

    ![Right side battery overhang](_attachments/IMG_2595_17518925041874182.JPG)

    *Battery overhang on right.*

    ![Material removal area](_attachments/battery_cage_bottom_1751892504202508.jpg)

    *Material removal area.*

    ![A Dremel or rotary tool with a deburring bit can be used to remove the material](_attachments/IMG_2607_17518925041974761.JPG)

    *A Dremel or rotary tool with a deburring bit can be used to remove the material.*

    ![Deburring bit](_attachments/IMG_2611_1751892504206351.JPG)

    *Deburring bit.*

    ![1-2mm of material removed. Repeat on the opposite side](_attachments/IMG_2612_1751892504211755.JPG)

    *1-2mm of material removed. Repeat on the opposite side.*

    ![Test fit](_attachments/IMG_2618_175189250421683.JPG)

    *Test fit.*

    ![Note the top of the battery lines up with a top line on the battery cage](_attachments/IMG_2619_1751892504222469.JPG)

    *Note the top of the battery lines up with a top line on the battery cage.*

    ![Flip the battery cage over and verify that the battery fully inserts to the bottom of the cage](_attachments/IMG_2622_1751892504230002.JPG)

    *Flip the battery cage over and verify that the battery fully inserts to the bottom of the cage.*

    ![Battery seated with no space between the bottom of the battery and the cage](_attachments/battery_cage_battery_seated_17518925042247272.jpg)
...
4. Add spacers to the bottom of the battery cage to elevate the new, shorter batteries 4mm.
    ...
    ![Side view of corrugated plastic](_attachments/IMG_2626_1751892504234263.JPG)

    *Side view of corrugated plastic.*

    ![Eight 1 3/4" x 3/8" and four 1 3/4" x 1 1/4" spacers are needed for each cage](_attachments/IMG_2627_1751892504240076.JPG)

    *Eight 1 3/4" x 3/8" and four 1 3/4" x 1 1/4" spacers are needed for each cage.*

    ![Use double-sided tape to affix the spacers to the bottom of the battery cage](_attachments/IMG_2629_1751892504245609.JPG)

    *Use double-sided tape to affix the spacers to the bottom of the battery cage.*

    ![Locations for spacers](_attachments/battery_cage_spacer_locations_175189250425204.jpg)

    *Locations for spacers.*

    ![Spacers installed](_attachments/IMG_2631_17518925042581701.JPG)

    *Spacers installed.*

    ![Battery installed on spacers](_attachments/IMG_2634_1751892504263669.JPG)

    *Battery installed on spacers.*

    ![Battery now sits slightly above the line in the battery cage](_attachments/IMG_2638_1751892504268196.JPG)
...
1. Affix 4mm spacers between the batteries.
    ...
    ![Three 1 1/2" x 1 1/2" spacers are needed for each set of four batteries](_attachments/IMG_2640_1751892504273325.JPG)

    *Three 1 1/2" x 1 1/2" spacers are needed for each set of four batteries.*

    ![3/4" wide foam-backed double sided tape](_attachments/IMG_2642_1751892504278489.JPG)

    *3/4" wide foam-backed double sided tape.*

    ![Shape of the spacer isn't critical. 1 1/2" x 1 1/2" was chosen as having approximately the same surface area (right) as the original spacer (left), while being a multiple of the 3/4" tape, which was the most conomical to purchase](_attachments/IMG_2644_17518925042834911.JPG)
...
2. Install the batteries in the battery cage. Pay attention to polarity.
    ...
    ![Ensure the batteries are fully seated and polarity is correct. Note the spacers between the batteries](_attachments/IMG_2645_1751892504288478.JPG)
...
3. Fabricate jumpers to attach the CMU to the batteries.
    ...
    ![The LEV50s have an extra set of mounting holes, used to attach the CMU electrically and thermally to the battery](_attachments/lev50_mounting_holes_1751892856373943.jpg)

    *The LEV50s have an extra set of mounting holes, used to attach the CMU electrically and thermally to the battery.*

    ![Bus bars were used to construct the jumpers. The 56mm length permitted the construction of a jumper, and a washer from the waste. The 6mm slots had to be ground out for the M8 terminals, as bus bars with 8mm lots weren't readily available](_attachments/IMG_2671_1751892504304107.JPG)
    ...
    *Jumpers and washers (top) were fabricated out bus bars (bottom). These were cut with a hack saw and then sanded to remove flashing and ensure good electrical contact for the high current application. The hole was tapped as an M3 x 0.5 to match the threads of the existing screws.*
    ...
    ![Jumper installed on the new battery (bottom) to provide the connection to the CMU. Old battery (top) shown for comparison. Washer also installed on the new battery as a spacer, so that both terminals are the ame height](_attachments/IMG_2553_1751892504298835.JPG)
...
1. Install jumpers and washers on battery terminals.
    ...
    ![Orient the CMU daughter board and battery cage based on the cut outs for the terminals. Add jumpers on the terminals that connect to the CMU board. Add washers on the remaining terminals](_attachments/installing_jumpers_1751892504328647.jpg)
    ...
    *Orient the CMU daughter board and battery cage based on the cut outs for the terminals. Add jumpers on the terminals that connect to the CMU board. Add washers on the remaining terminals.*
    ...
    ![Tip: Nuts can be tightened against the jumpers temporarily to keep the jumpers from rotating and shorting to adjacent terminals when the webbing is installed in the subsequent step](_attachments/IMG_2712_1751892504311129.JPG)
...
2. Install the plastic webbing and CMU on the battery cage.
    ...
    ![Plastic webbing with CMU daughter board installed on battery cage](_attachments/IMG_2650_1751892504322616.JPG)
...
3. Align the jumpers with the holes in the CMU board and start the screws.
    ...
    ![Align the threaded holes on the jumpers with the CMU board holes. A nut, no tighter than finger tight, can be used on the terminal to hold the jumper in place if necessary](_attachments/IMG_2652_1751892504322809.JPG)
    ...
    *Align the threaded holes on the jumpers with the CMU board holes. A nut, no tighter than finger tight, can be used on the terminal to hold the jumper in place if necessary.*
    ...
    ![Floating tabs on the circuit board allow for slight, independent movement of the batteries from the board. These are delicate. Too much stress or movement and these will break](_attachments/circuit_board_flex_front_1751892504339487.jpg)
    ...
    *Floating tabs on the circuit board allow for slight, independent movement of the batteries from the board. These are delicate. Too much stress or movement and these will break. Shown here mounted to the original LEV 50.*
    ...
    ![View of the floating tab from the back side of the circuit board (not visible at this point in assembly)](_attachments/IMG_2729_17518925043339531.JPG)

    *View of the floating tab from the back side of the circuit board (not visible at this point in assembly).*

    ![Screws installed but not tightened](_attachments/IMG_2653_17518925043478029.JPG)
...
4. Install the three bus bars and 6 nuts; tighten to specification.
    ...
    ![Install bus bars and nuts](_attachments/installing_bus_bars_1751892504359585.jpg)
...
5. Tighten the CMU screws. Watch for the circuit board being stressed while tightening. Stop and adjust/realign if necessary to avoid breaking the delicate board.
    ...
    ![Add a terminal nut (finger tight only) to the unsupported jumper to prevent the jumper from tilting down and stressing the circuit board while tightening the screw](_attachments/tightening_screws_175189250436522.jpg)
...
1. Measure the voltage of the submodule.
    ...
    ![Voltage will depend on the state of charge of the cells, but should be approximately 4 * 3.7 volts = 14.8 volts](_attachments/IMG_2715_1751892504353921.JPG)
...
2. Rebuild the second submodule in the same fashion.
    ...
    ![Note that the CMU main board uses 5 jumpers instead of 4](_attachments/cmu_installing_jumpers_17518925043717802.jpg)
...
1. Reinstall the bottom clam shell on both submodules.
    ...
    ![Note the positioning and orientation of the submodules and clam shell](_attachments/IMG_2687_1751892504377661.JPG)

    *Note the positioning and orientation of the submodules and clam shell.*

    ![Bottom clam shell installed](_attachments/IMG_2688_175189250439027.JPG)

    *Bottom clam shell installed.*

2. Reinstall the cable between the CMU main board and daughter board.

    ![Installing the jumper cable](_attachments/IMG_2690_1751892504408801.JPG)

    *Installing the jumper cable.*

3. Reinstall the bus bar between the two submodules. Tighten nuts according to specification.

    ![Install the bus bar between the two submodules. Tighten nuts according to specification](_attachments/bus_bar_between_submodules_17518925044083042.jpg)

    *Install the bus bar between the two submodules. Tighten nuts according to specification.*

4. Reinstall the plastic cover.

    ![Plastic cover reinstalled](_attachments/IMG_2694_1751892504384494.JPG)

    *Plastic cover reinstalled.*

5. Check the voltage of the module.

    ![Voltage will depend on the state of charge of the batteries, but should be approximately 8 * 3.7 = 29.6 volts](_attachments/IMG_2695_1751892504395612.JPG)
...
6. Reinstall the top metal clam shell.
    ...
    ![Top clam shell snapped onto the plastic tabs](_attachments/IMG_2697_1751892504415261.JPG)
...
7. Reinstall the mounting brackets to hold the top and bottom clam shells together.
    ...
    ![Left bracket (connector side) reinstalled](_attachments/IMG_2698_1751892504419869.JPG)

    *Left bracket (connector side) reinstalled.*

    ![Right bracket reinstalled](_attachments/IMG_2699_1751892504425451.JPG)
